...
function Footer() {
    ...
    return (
        <footer>
          ...
          <a href="https://www.github.com/celinechadwick">
            <svg id="git" width="1024" height="1024" viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="https://www.linkedin.com/in/celinechadwick/">
            <svg id="linkedin" fill="#000000" height="200px" width="200px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 455 455">
                <g>
            ...
            <div className="footer">
                <p>&copy; <span id="current-year"></span> Celine Chadwick. All Rights Reserved.</p>
            </div>
        </footer>
    );
}
